<%@ Page Language="C#" AutoEventWireup="true" CodeFile="float-clear-f.aspx.cs" Inherits="float_html_float_clear_f" %>
...
<body>
    ...
    <div id="container"> 
      ...
      <h3>Simon Collison</h3> 
        <div class="image_float"><img src="../float-image/8.jpg" alt="Simon Collison's mugshot" /></div> 
       ...
       <h3>Jimi Hendrix</h3> 
        <div class="image_float"><img src="../float-image/8.jpg" alt="Jimi Hendrix's mugshot" /></div> 
        ...
        <h3>Janis Joplin</h3> 
	    <div class="image_float"><img src="../float-image/8.jpg" alt="Joplin's mugshot" /></div> 
	  ...
	  <h3>John Lennon</h3> 
	    <div class="image_float"><img src="../float-image/8.jpg" alt="Lennon's mugshot" /></div> 
	    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Vestibulum in lacus. ... Quisque vitae lorem placerat risus posuere congue. Integer a orci.</p> 
