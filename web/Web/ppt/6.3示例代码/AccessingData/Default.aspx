...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
            BackColor="#993366" DataKeyNames="BookID" DataSourceID="SqlDataSource1" 
        ...
        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="BookID" HeaderText="BookID" InsertVisible="False" 
                    ReadOnly="True" SortExpression="BookID" />
                <asp:BoundField DataField="LastReadOn" DataFormatString="{0:d}" 
                    HeaderText="LastReadOn" HtmlEncode="False" SortExpression="LastReadOn" />
            </Columns>
        </asp:GridView>
        <br />
